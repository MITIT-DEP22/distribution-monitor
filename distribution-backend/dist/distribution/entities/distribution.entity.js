...
__decorate([
    (0, swagger_1.ApiProperty)(),
    (0, typeorm_1.OneToOne)(() => serviceman_entity_1.Serviceman),
    (0, typeorm_1.JoinColumn)(),
    __metadata("design:type", serviceman_entity_1.Serviceman)
], Distribution.prototype, "serviceman", void 0);
__decorate([
    (0, swagger_1.ApiProperty)(),
    (0, typeorm_1.OneToOne)(() => position_entity_1.Position),
    (0, typeorm_1.JoinColumn)(),
    __metadata("design:type", position_entity_1.Position)
], Distribution.prototype, "position", void 0);
__decorate([
    (0, swagger_1.ApiProperty)(),
    (0, typeorm_1.OneToOne)(() => release_year_entity_1.ReleaseYear),
    (0, typeorm_1.JoinColumn)(),
    __metadata("design:type", release_year_entity_1.ReleaseYear)
], Distribution.prototype, "releaseYear", void 0);
__decorate([
    (0, swagger_1.ApiProperty)(),
    (0, typeorm_1.OneToOne)(() => military_base_entity_1.MilitaryBase),
    (0, typeorm_1.JoinColumn)(),
    __metadata("design:type", military_base_entity_1.MilitaryBase)
], Distribution.prototype, "militaryBase", void 0);
